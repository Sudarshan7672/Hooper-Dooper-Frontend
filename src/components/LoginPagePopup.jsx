...
export default function LoginPagePopup() {
    ...
    return (
        <>
            <button onClick={() => setIsModalOpen(true)} className="bg-blue-500 text-white px-2 py-1/2 rounded-sm">
                Login
            </button>
            ...
            <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mt-[20px]">
                        <label htmlFor="username" className="block">Email Address</label>
                        <input
                            type="text"
                            id="username"
                            value={username}
                    ...
                    <div className="w-full mt-[20px] flex justify-center">
                        ...
                        <button type="submit" className="h-[30px] w-[100px] bg-black text-white rounded-xl flex justify-center items-center">
                            <p>Log in</p>
                        </button>
                        </div>
