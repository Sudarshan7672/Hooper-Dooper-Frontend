                    ...
                    <div> 
                        <form action="" onSubmit={handleSubmit}>
                            ...
                            <div className="mt-[20px]">
                                ...
                                }} required className="w-full rounded-md border-2 h-[35px]" placeholder="Enter Your Email" />
                            </div>
                            <div>
                                <p>Password</p>
                                <input type="password" value={password} onChange={(e)=>{
                                    setPassword(e.target.value);
                                }} required className="w-full rounded-md border-2 h-[35px]" placeholder="Enter Your Password" />
                            </div>
                            <div className="w-full mt-[20px] flex justify-center">
                                <button type="submit">
